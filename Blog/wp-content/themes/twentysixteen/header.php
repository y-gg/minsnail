	...
	<div class="site-inner">
		...
		<div style="margin-top:10px;margin-bottom:10px;">
			<div class="btn-group btn-group-lg">
				<a type="button" class="btn btn-default btnh" href="/snail">Home</a>
				<a type="button" class="btn btn-default" href="/snail/Home/index/news">News</a>
				<a type="button" class="btn btn-default" href="/snail/Home/index/weather">Weather</a>
				<a type="button" class="btn btn-default btnl" >Blog</a>
			</div>
		</div>
		<div style="border-top: 4px solid #ef2d36;margin-bottom:5px;"></div>
